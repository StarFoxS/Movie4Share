...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    static UserDao userDao = Movie4ShareApplication.getInstances().getDaoSession().getUserDao();
//    static SellerDao sellerDao =
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailView = (AutoCompleteTextView) findViewById(R.id.login_id_textview);
        mEmailView.setHintTextColor(getResources().getColor(R.color.lightGray));
        populateAutoComplete();
        mEmailIcon = (ImageView)findViewById(R.id.email_icon);

        mPasswordView = (EditText) findViewById(R.id.password);
        mPasswordView.setTextColor(getResources().getColor(R.color.lightGray));
//        mPasswordView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
//            @Override
//            public boolean onEditorAction(TextView textView, int id, KeyEvent keyEvent) {
//                if (id == EditorInfo.IME_ACTION_DONE || id == EditorInfo.IME_NULL) {
//                    attemptLogin("user");   //TODO
//                    return true;
//                }
//                return false;
//            }
//        });
        ...
        Button mSellerSignInButton = (Button) findViewById(R.id.seller_sign_in_button);
        ...
        Button mAdminSignInButton = (Button) findViewById(R.id.admin_sign_in_button);
...
//        mLoginFormView = findViewById(R.id.login_form);
     ...
     *
     *  @param requestIdentity either "user"/"seller"/"admin"
     */
    private void attemptLogin(String requestIdentity) {
        if (mAuthTask != null) {
            return;
        }
...
//        }
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(email, password, requestIdentity);
...
//            mLoginFormView.setVisibility(show ? View.GONE : View.VISIBLE);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String email, String password, String identity) {
            mEmail = email;
            mPassword = password;
            mIdentity = identity;
        }
                ...
                case "user":
                    ...
                    for (int i = 0; i < userList.size(); i++){
                        if (userList.get(i).getCustomId().equals(mEmail) &&
                            ...
                            Movie4ShareApplication.userId = userList.get(i).getId();
                            Movie4ShareApplication.vip = userList.get(i).getVip();
                            Movie4ShareApplication.couponTotal = userList.get(i).getCouponTotal();
                            Movie4ShareApplication.couponMinus = userList.get(i).getCouponMinus();

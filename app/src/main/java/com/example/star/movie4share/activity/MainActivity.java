...
//            }
//        });
        //Snackbar.make().setAction("Action", null).show();
...
//        mFragments[1] = fragmentManager.findFragmentById(R.id.homePage);
//        mFragments[2] = fragmentManager.findFragmentById(R.id.homePage);
//        mFragments[3] = fragmentManager.findFragmentById(R.id.homePage);
//        mFragments[4] = fragmentManager.findFragmentById(R.id.homePage);
    }
